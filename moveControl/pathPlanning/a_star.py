...
def get_path(baidu_map_obj,
    ...
    global path_matrix
    if server_config.home_debug and baidu_map_obj is None:
        baidu_map_obj = baidu_map.BaiduMap(server_config.ship_gaode_lng_lat, zoom=16, scale=1,
    ...
    # 多点
        ...
        # 使用TSP优化路径
        if server_config.b_tsp:
            # 测量距离
            distance_matrix = measure_distance(target_pixs, baidu_map_obj.pool_cnts, map_connect=server_config.find_points_num)
